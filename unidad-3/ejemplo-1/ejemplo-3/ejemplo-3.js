...
function evalOpcionVSwitch () {
    ...
    switch(opcion) {
        case 'mitad': pResultado.textContent = 'La mitad es ' + (numero/2);
        break;
        case 'cuadrado': pResultado.textContent = 'El cuadrado es ' + (numero*numero);
        break;
        case 'par': if(numero%2 === 0) {
        ...
        break;
        default: pResultado.textContent = '';
    }
}
function evalOpcion() {
    var numero = Number(inputNumero.value);
